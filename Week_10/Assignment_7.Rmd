...
# Def batched function to apply get_sentiment() 
get_sentiments_batch <- function(tweets, ids, delay = 1) {
  results <- vector("list", length(tweets))  # Preallocate result list
...
```{r summary-stats}
summary_sentiment_results <- sentiment_results_wider |> 
```
