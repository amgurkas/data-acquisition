...
# Avg Pre-Chess Rating of Opponent for 1st player matched w/

## EX: for the first player the results should be - 
### Gary Hua, ON, 6.0, 1794, 1605
#### 1605 was calculated by using the pre-tournament opponents' ratings of:
##### 1436, 1563, 1600, 1610, 1649, 1663, 1716, and dividing by the total # of 
###### games played. 

# tbl1 has: player name, state, total_pts, rtg_pre, pair_id
